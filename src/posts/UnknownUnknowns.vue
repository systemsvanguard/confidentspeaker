<template>
  <div class="container">
    <h1 class="text-primary">Known Knowns, Unknown Unknowns, and Known Unknowns</h1>
    <h5 class="my-2"><strong><em>Published on 28 March 2024 10:00 AM</em></strong></h5>
    <div class="my-3"> 
       <img class="img-fluid rounded" src="/images/unknown_unknown.png" alt="Preparing for Uncertainty in Public Speaking" />	  
    </div> 
    
    <h1>Known Knowns, Unknown Unknowns, and Known Unknowns</h1>
...
<p>In a USA Department of Defense briefing on February 12, <bold>2002<bold>, former 2 time Secretary of Defense Donald Rumsfeld popularized the former management concept, and gifted us the inimitable and memorable quote above, regarding the lack of evidence linking the government of Iraq with the supply of weapons of mass destruction to terrorist groups.  The <a href="https://www.plainenglish.co.uk/campaigning/awards.html">British Plain English Campaign</a> duly awarded Rumsfeld the <bold>2003 Foot in Mouth Award</bold>.</bold></bold></p>
...
<img src="../assets/images/rumsfeld_unknown_knowns.png" alt="Unknown Unknowns and Known Unknowns" style="width:773px"> 
