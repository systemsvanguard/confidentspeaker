<template>
  <div class="container">
    <h1 class="text-primary">12 Tips to Improve Your Public Speaking</h1>
	<h5 class="my-2" ><strong><em>Published on 17 March 2024 11:00 AM</em></strong></h5>
    <div class="my-3">
	  <img class="img-fluid rounded" src="/images/12_tips_to_improve_speaking.png" alt="12 Tips to Improve Your Public Speaking">	  
    </div>
