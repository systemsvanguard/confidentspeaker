<template>
  <div class="container">
    <h1 class="text-primary">When You Have Too Much to Do</h1>
	<h5 class="my-2" ><strong><em>3 March 2024 05:51 PM</em></strong></h5>
    <div class="my-3">
	  <img class="img-fluid rounded" src="/images/much-to-do.jpg" alt="When You Have Too Much to Do">	  
    </div>
	
	
<p>You have a to-do list that scrolls on for days. You are managing multiple projects, getting lots of email and messages on different messaging systems, managing finances and personal health habits and so much more.</p>
...
<h2>Third: Schedule Time to Simplify</h2>
...
<h2>Fourth: Practice Mindful Focus</h2>
