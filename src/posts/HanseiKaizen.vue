<template>
  <div class="container">
    <h1 class="text-primary">Hansei & Kaizen for Presenters</h1>
	<h5 class="my-2" ><strong><em>Published on 08 March 2024 08:00 AM</em></strong></h5>
    <div class="my-3">
	  <img class="img-fluid rounded" src="/images/kaizen.png" alt="Hansei & Kaizen for Presenters">	  
    </div>
...
<img class="img-fluid rounded" src="/images/hansei.png" alt="Hansei ~ Continuous Improvement" style="width:714px"> 
