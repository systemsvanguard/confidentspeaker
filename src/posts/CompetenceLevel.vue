<template>
  <div class="container">
    <h1 class="text-primary">The Four Levels of Competency</h1>
	<h5 class="my-2" ><strong><em>Published on 29 March 2024 11:00 AM</em></strong></h5>
    <div class="my-3">
	  <img class="img-fluid rounded" src="/images/competence_levels.png" alt="The Four Levels of Competency">	  
    </div>
